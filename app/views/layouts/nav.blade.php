		...
		<div class="navbar navbar-default" role="navigation">
			...
			<nav id="menu" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a {{ Request::path() == '/' ? 'class="active"' : 'href="/" title="Decarlini Maside Arquitectura y Dise&ntilde;o"' }}>Inicio</a></li>
					...
					<li><a {{ Request::path() == 'quienes-somos' ? 'class="active"' : 'href="/quienes-somos" title="Qui&eacute;nes somos"' }}>Qui&eacute;nes somos</a></li>
