		...
		<form name="formNuevoProyecto" id="formNuevoProyecto" novalidate ng-controller="ProyectoController as proyectoCtrl" ng-submit="formNuevoProyecto.$valid && proyectoCtrl.addProyecto()">
			<div class="row">
				<div class="col-sm-3">
					...
					{{ Form::text('titulo', $proyecto->titulo, array(
								        	'id' 		=> 'titulo',
				...
				<div class="col-sm-3">
					...
					<div class="input-group">
						{{ Form::text('superficie', $proyecto->superficie, array(
															'id'	=> 'superficie',
															'class' => 'form-control',
				...
				<div class="col-sm-3">
					...
					{{ Form::text('ano', $proyecto->ano, array(
								        	'id' => 'ano',
			...
			<div class="row">
				<div class="col-sm-3">
					...
					{{ Form::select('categoria',
											array('' => 'Seleccione una categor&iacute;a') + Categoria::orderBy('nombre')->lists('nombre', 'id'), $proyecto->categoria_id, array('id' => 'categoria', 'ng-model' => 'proyectoCtrl.proyecto.categoria', 'required')) }}
